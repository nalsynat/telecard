...
function headerSVG(): Buffer {
  return Buffer.from(
    ...
    '<text x="540" y="210" font-family="' + FONT + '" font-size="96" font-weight="bold" fill="white" text-anchor="middle">TeleCard</text>' +
    '</svg>'
  )
}
...
function actionSVG(name: string, title: string): Buffer {
  ...
  return Buffer.from(
    ...
    '<text x="540" y="100" font-family="' + FONT + '" font-size="64" font-weight="bold" fill="white" text-anchor="middle" dominant-baseline="middle">' + n + '</text>' +
    '<text x="540" y="180" font-family="' + FONT + '" font-size="32" fill="#7B001C" text-anchor="middle" dominant-baseline="middle" letter-spacing="6">' + t + '</text>' +
